            ...
            for (var index = 0; index < length; index++) {
                ...
                if (this.mode === 'probability') {
                    ...
                    if (['independent', 'single', 'negative', 'single_fixedsquare', 'single_fixedcircle'].indexOf(self.mode) !== -1) {
                        if (index === 0) {
                            text = '(A: ' + self.selected[index].x + ', B: ' + self.selected[index].y + ')'
                        }else{
                            text = '(A: ' + self.selected[index].x + ', B: ' + self.selected[index].y + ')'
                        }
                ...
                var drag = d3.drag().on('drag', function(d) {
                    ...
                    if (['independent', 'single', 'negative', 'single_fixedsquare', 'single_fixedcircle'].indexOf(self.mode) !== -1) {
                        if (index == 0) {
                            text = '(A: ' + xValue.toFixed(self.precision) + ', B: ' + yValue.toFixed(self.precision) + ')'
                        }else{
                            text = '(A: ' + xValue.toFixed(self.precision) + ', B: ' + yValue.toFixed(self.precision) + ')'
                        }
                    }else if (self.mode === 'single_given') {
                    ...
                    if (self.mode !== 'probability') {
                        ...
                        switch (self.mode) {
                            ...
                            if (otherIndex == 0) {
                                otherText = '(A: ' + otherXValue.toFixed(self.precision) + ', B: ' + otherYValue.toFixed(self.precision) + ')'
                            }else{
                                otherText = '(A: ' + otherXValue.toFixed(self.precision) + ', B: ' + otherYValue.toFixed(self.precision) + ')'
                            }
