...
# {'mode': 'sec_new_graph', 'm': 50, 'p_x': 1, 'p_y': 1,'m2': 40, 'p_x2': 0.6, 'p_y2': 1, 'prob_a': 100, 'label': {'x': 'Tareas a completar hoy', 'y': 'Tareas a completar en la siguiente semana'}, 'bloque': 'simultaneous', 'numero': 24}, #bloque 23
# {'mode': 'sec_new_graph', 'm': 60, 'p_x': 1, 'p_y': 1.4,'m2': 40, 'p_x2': 0.6, 'p_y2': 1, 'prob_a': 100, 'label': {'x': 'Tareas a completar hoy', 'y': 'Tareas a completar en la siguiente semana'}, 'bloque': 'simultaneous', 'numero': 24}, #bloque 23
# {'mode': 'sec_new_graph', 'm': 60, 'p_x': 1, 'p_y': 1.4,'m2': 50, 'p_x2': 1, 'p_y2': 1, 'prob_a': 100, 'label': {'x': 'Tareas a completar hoy', 'y': 'Tareas a completar en la siguiente semana'}, 'bloque': 'simultaneous', 'numero': 24}, #bloque 23
# ],
# [
# {'mode': 'dictator', 'prob_a': 100, 'm': 40, 'p_y': 0.6, 'p_x': 1, 'label': {'x': 'Tareas a completar hoy (tú)', 'y': 'Tareas a completar hoy (pareja)'}, 'bloque': 'dictator', 'numero': 25}, #bloque 24
# {'mode': 'dictator', 'prob_a': 100, 'm': 45, 'p_y': 0.8, 'p_x': 1, 'label': {'x': 'Tareas a completar hoy (tú)', 'y': 'Tareas a completar hoy (pareja)'}, 'bloque': 'dictator', 'numero': 25}, #bloque 24
# {'mode': 'dictator', 'prob_a': 100, 'm': 50, 'p_y': 1, 'p_x': 1, 'label': {'x': 'Tareas a completar hoy (tú)', 'y': 'Tareas a completar hoy (pareja)'}, 'bloque': 'dictator', 'numero': 25}, #bloque 24
# {'mode': 'dictator', 'prob_a': 100, 'm': 55, 'p_y': 1.2, 'p_x': 1, 'label': {'x': 'Tareas a completar hoy (tú)', 'y': 'Tareas a completar hoy (pareja)'}, 'bloque': 'dictator', 'numero': 26}, #bloque 24
# {'mode': 'dictator', 'prob_a': 100, 'm': 60, 'p_y': 1.4, 'p_x': 1, 'label': {'x': 'Tareas a completar hoy (tú)', 'y': 'Tareas a completar hoy (pareja)'}, 'bloque': 'dictator', 'numero': 26}, #bloque 24 
# {'mode': 'dictator', 'prob_a': 100, 'm': 60, 'p_y': 1.4, 'p_x': 1, 'label': {'x': 'Tareas a completar hoy (tú)', 'y': 'Tareas a completar hoy (pareja)'}, 'bloque': 'dictator', 'numero': 26}, #bloque 24 
